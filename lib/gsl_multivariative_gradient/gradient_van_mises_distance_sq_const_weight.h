#ifndef GRADIENT_VAN_MISES_DISTANCE_SQ_CONST_WEIGHT_H
#define GRADIENT_VAN_MISES_DISTANCE_SQ_CONST_WEIGHT_H

#include "dirac_to_dirac_optimization_params.h"
#include "gsl_minimizer.h"
#include "gsl_multivariative_gradient_template.h"

class gradient_van_mises_distance_sq_const_weight
 ...
 public:
  ...
  void multivariativeGradient(const gsl_vector* x, gsl_vector* grad,
    ...
    gsl_function F;
    F.function =
        gradient_van_mises_distance_sq_const_weight::scalarFunctionWrapper;
    F.params = &gp;
...
#endif  // GRADIENT_VAN_MISES_DISTANCE_SQ_CONST_WEIGHT_H