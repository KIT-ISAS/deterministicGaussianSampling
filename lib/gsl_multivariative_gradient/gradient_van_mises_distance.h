#ifndef GRADIENT_VAN_MISES_DISTANCE_H
#define GRADIENT_VAN_MISES_DISTANCE_H

#include "gsl_minimizer.h"
#include "gsl_multivariative_gradient_template.h"

class gradient_van_mises_distance
    : public gsl_multivariative_gradient_template<void> {
 public:
  ...
  void multivariativeGradient(const gsl_vector* x, gsl_vector* grad,
                              VectorFunc f, void* params,
    ...
    gp.f = f;
    gsl_function F;
    F.function = gradient_van_mises_distance::scalarFunctionWrapper;
    F.params = &gp;
...
#endif  // GRADIENT_VAN_MISES_DISTANCE_H